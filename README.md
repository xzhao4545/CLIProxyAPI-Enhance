...
### Keyword Filters
- Configure keyword rules that mark matching responses as failed and suspend the provider for load balancing
...
This repository is a fork of [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) with the additions above.
...
Upstream CLIProxyAPI no longer ships built-in usage statistics. **This fork keeps built-in SQLite usage statistics** (see Features above). You may also use third-party tools:
