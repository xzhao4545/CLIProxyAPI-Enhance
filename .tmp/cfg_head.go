...
const (
	DefaultPanelGitHubRepository = "https://github.com/xzhao4545/Cli-Proxy-API-Management-Center-Ehance"
...
type Config struct {
	...
	// Usage configures fork-owned SQLite usage statistics persistence.
